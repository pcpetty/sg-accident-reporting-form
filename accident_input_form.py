...
def reporting_procedure(accident_reporting_procedure):
...
def collect_accident_data():
    ...
    return collect_accident_data()
# ------------------------------------------------------------------------
# Main Function
def main():
    print("Safety Generalist Accident Report Form")
    if get_yes_no("Would you like an accident reporting SOP tutorial? (y/n): "):
        print("Tutorial skipped for brevity. Add the full version here.")
